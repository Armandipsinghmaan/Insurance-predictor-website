document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('predictButton').addEventListener('click', function() {
        ...
        // Simulate a prediction process (replace with actual API call or calculation)
        predictionText.innerHTML = "Calculating your best insurance plan...";
        setTimeout(() => {
            predictionText.innerHTML = "Based on your inputs, the best insurance plan for you includes comprehensive health coverage with a minimal deductible.";
